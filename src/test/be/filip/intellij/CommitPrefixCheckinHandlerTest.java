...
class CommitPrefixCheckinHandlerTest {
    ...
    public void updatePrefix_existingMessage_updatedCorrectly() {
        ...
        assertThat(result, is("fve: ABC-1234: This is my text"));
    }

    @Test
    public void updatePrefix_delimiterWithoutMessage_updatedCorrectly() {
        String result = CommitPrefixCheckinHandler.updatePrefix("ABC-1234", "XYXY-837292:", ": ", "fve");
        assertThat(result, is("fve: ABC-1234: "));
    }

    @Test
    public void updatePrefix_wrongDelimiter_issueNotRecognized() {
        String result = CommitPrefixCheckinHandler.updatePrefix("ABC-1234", "XYXY-837292: This is my text", " | ", "fve");
        assertThat(result, is("fve: ABC-1234 | XYXY-837292: This is my text"));
    }

    @Test
    public void updatePrefix_specialDelimiter_updatedCorrectly() {
        String result = CommitPrefixCheckinHandler.updatePrefix("ABC-1234", null, " :_-/|,.", "fve");
        assertThat(result, is("fve: ABC-1234 :_-/|,."));
    }

    @Test
    public void updatePrefix_doubledPattern_updatedCorrectly() {
        String result = CommitPrefixCheckinHandler.updatePrefix("ABC-1234", "XYXY-837292: XYZ-11 This is my text", ": ", "fve");
        assertThat(result, is("fve: ABC-1234: XYZ-11 This is my text"));
    }

    @Test
    public void updatePrefix_null_updatedCorrectly() {
        String result = CommitPrefixCheckinHandler.updatePrefix("ABC-1234", null, ": ", "fve");
        assertThat(result, is("fve: ABC-1234: "));
    }

    @Test
    public void updatePrefix_emptyMessage_updatedCorrectly() {
        String result = CommitPrefixCheckinHandler.updatePrefix("ABC-1234", "", ": ", "fve");
        assertThat(result, is("fve: ABC-1234: "));
    }
    ...
    public void updatePrefix_existingMessageWithBlanks_updatedCorrectly() {
        String result = CommitPrefixCheckinHandler.updatePrefix("ABC-1234", "   XYXY-837292:  This is a Test     ", ": ", "fve");
        assertThat(result, is("fve:    ABC-1234:  This is a Test     "));
    }

    @Test
    public void updatePrefix_existingMessageWithPrefixInText_updatedCorrectly() {
        String result = CommitPrefixCheckinHandler.updatePrefix("ABC-1234", "   According to issue XYXY-837292: this fix...     ", ": ", "fve");
        assertThat(result, is("fve: ABC-1234:    According to issue XYXY-837292: this fix...     "));
    }
    ...
    public void getJiraTicketName_withoutBranchType_retunsJiraTicket() {
        ...
        assertThat(result.get(), is("fve: ABC-1234"));
    }
